...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<UploadPhotoResponse> uploadPhoto(File photo) async {
    final _extra = <String, dynamic>{'auth': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<UpdateOrderStateResponse> updateOrderState(
    ...
    final _options = _setStreamType<UpdateOrderStateResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateOrderStateResponse _value;
    try {
      _value = UpdateOrderStateResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
